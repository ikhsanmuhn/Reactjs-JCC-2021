...
import { Layout , Button , Input , Form , InputNumber , Rate , Select, message } from 'antd';
    ...
    const handleSubmit = (event) =>{
        ...
        .then(res => {
            setInput({title: "",
                ...
                review: "",
                image_url: ""})
            message.success('Movie has been added');
    ...
    return(
        <Content style={{backgroundColor: "#8512A1"}}>
            <div style={{padding: "100px"}}>
                <p style={{fontSize: "20px", float:"left", color:"#ffffff"}}><strong>Add New Movie</strong></p>
                <div className="container-create">
                    <Form
                        ...
                        >
                        <InputNumber min={2002} max={2025} defaultValue={2002} onChange={handleChangeYear}/>
                        </Form.Item>
