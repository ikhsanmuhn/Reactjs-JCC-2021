...
import { Form, Input, Layout, Table , Button, Space, message } from 'antd';
import{EditOutlined,DeleteOutlined,ClearOutlined } from '@ant-design/icons'
  ...
  const columns = [
      ...
      },
      {
        ...
        render: (record) => {
          return(
            <>
            <img src={record} style={{width: "70px", height: "auto", borderRadius:"5px", objectFit: "cover"}}/>
            </>
          )
        }
      },
    ...
    return(
        <Content style={{backgroundColor: "#8512A1"}}>
          <div style={{padding: "90px"}}>
            <h1 style={{fontSize: "20px", color:"#ffffff"}}><strong>Games Data</strong></h1>
            <Space style={{ marginBottom: 16 }}>
              ...
              <Button type="primary button" href={'/games-create'} style={{borderRadius:"5px"}}>Add Game</Button>
              <Button onClick={clearFilters}style={{marginLeft:"380px",backgroundColor:"#8512A1", color:"#ffffff", borderRadius:"5px"}}><ClearOutlined /> Filters</Button>
              <Button onClick={clearAll} style={{backgroundColor:"#8512A1", color:"#ffffff", borderRadius:"5px"}}><ClearOutlined /> sorters</Button>
            </Space>
